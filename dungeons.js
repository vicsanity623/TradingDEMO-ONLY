...
(function() {
    ...
    window.startDungeon = function(bossKey) {
        ...
        document.getElementById('db-player-img').src = document.getElementById('ui-sprite').src || "IMG_0061.png";
